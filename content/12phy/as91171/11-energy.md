...
\begin{aligned}
    & v_{i} = 44.8ms^{-1}, v_{f} = 0ms^{-1}, a = -9.8ms^{-2} && \text{(K)}  \newline
    & t = ? && \text{(U)} \newline
    & v_{f} = v_{i} + at && \text{(F)} \newline
    & 0 = 44.8 + (-9.8)t && \text{(S+S)} \newline
...
\begin{aligned}
    & v_{i} = 44.8ms^{-1}, v_{f} = 0ms^{-1}, a = -9.8ms^{-2} && \text{(K)}  \newline
    & d = ? && \text{(U)} \newline
    & v_{f}^{2} = v_{i}^{2} + 2ad && \text{(F)} \newline
    & 0^{2} = 44.8^{2} + 2(-9.8)d && \text{(S+S)} \newline
