...
Protons have a \fillinunderline{positive} charge, electrons have a \fillinunderline{negative} charge, and neutrons have \fillinunderline{no} change. Protons and electrons have an equal but opposite sized charge despite their very different masses.
...
\begin{enumerate}
	...
	\item Describe on way in which Thomson's and Rutherford's models of the atom were similar.\vspace{1.5cm}
	\item Describe the key difference between Thomson's and Rutherford's model of the atom.\vspace{1.5cm}
	\item In front of the alpha emitter is a lead screen with a narrow slit cut in it. What funciton does this lead screen serve?\vspace{2cm}
	\item What would Rutherford have seen if Thomson's model of the atom was correct?\vspace{2cm}
	\item What would have been observed if Rutherford used a beta emitted instead of an alpha emitter?\vspace{2cm}
\end{enumerate}
...
\begin{enumerate}
	\item State which elements tend to be naturally radioactive and explain why.\vspace{3cm}
    ...
    \end{figure}
	\item Describe what happens to the atomic number and mass number of a nucleus which emits a beta particle.\vspace{1.5cm}
\end{enumerate}
...
\begin{enumerate}
	...
	\item Explain why the emission/particle whose path was bent downwards was deflected further from its original path than the emission/particle whose path bent upwards. (Assume that both emission/particles had the same speed when they left the radioactive source.) \vspace{3cm}
\end{enumerate}
...
\begin{enumerate}
	...
	\item Write an equation for the decay of iridium and name the particle emitted.\vspace{1.5cm}
