...
\multicolumn{1}{|l|}{\textbf{Alpha Particle}} 		& \fillinblank{Large}   & \fillinblank{+2}      & \fillinblank{0.1 of light}   & \fillinblank{High} 		\\ \hline
\multicolumn{1}{|l|}{\textbf{Beta Minus Particle}}  & \fillinblank{Small}   & \fillinblank{-1}      & \fillinblank{0.9 of light}   & \fillinblank{Medium} 		\\ \hline
\multicolumn{1}{|l|}{\textbf{Gamma Ray}}      		& \fillinblank{None}    & \fillinblank{None}    & \fillinblank{speed of light}  & \fillinblank{Low} 		\\ \hline
\end{tabular}
\end{table}
