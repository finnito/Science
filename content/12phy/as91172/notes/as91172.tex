...
\begin{enumerate}
	...
	\item Describe one way in which Thomson's and Rutherford's models of the atom were similar.\vspace{1.5cm}
	\item Describe the key difference between Thomson's and Rutherford's model of the atom.\vspace{1.5cm}
	\item In front of the alpha emitter is a lead screen with a narrow slit cut in it. What function does this lead screen serve?\vspace{2cm}
	\item What would Rutherford have seen if Thomson's model of the atom was correct?\vspace{2cm}
	\item What would have been observed if Rutherford used a beta emitter instead of an alpha emitter?\vspace{2cm}
\end{enumerate}
...
\multicolumn{1}{|l|}{\textbf{Beta Minus Particle}}  &               &                 &                &                           \\ \hline
