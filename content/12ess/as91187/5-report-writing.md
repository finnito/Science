...
> e.g. The aim of this experiment is to investigate the relationship between [_your independent variable here_] and [_your dependent variable here_].
...
You _can_ measure multiple variables, but your report will be easier to write if you only measure one.
...
> e.g. In our whakamātau we investigated [_your aim here_] and we found that when [_your data summary here_]. This is reflected in our data, for example [_your example data here_]. This [_supports/does not support_] our hypothesis that [_your hypothesis here_].
